...
from op.objects import Object, fmt, fqn, items, keys, update, values
...
class TestObject(unittest.TestCase):
    ...
    def test_module(self):
        self.assertEqual(Object().__module__, "op.objects")

    def test_fqn(self):
        self.assertEqual(fqn(Object()), "op.objects.Object")
